...
def _process_measurement_list(agentAttestState, lines, lists=None, m2w=None, pcrval=None, ima_keyring=None, boot_aggregates=None, physical_tpm = 1):
    ...
    #SILVIOOOO    
    string = "/usr/share/ca-certificates/mozilla/NetLock"
...
def process_measurement_list(agentAttestState, lines, lists=None, m2w=None, pcrval=None, ima_keyring=None, boot_aggregates=None, physical_tpm = 1):
    result = None
    try:
        result = _process_measurement_list(agentAttestState, lines, lists=lists, m2w=m2w, pcrval=pcrval, ima_keyring=ima_keyring, boot_aggregates=boot_aggregates, physical_tpm = physical_tpm)
