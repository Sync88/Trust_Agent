...
class tpm(tpm_abstract.AbstractTPM):
    ...
    def ml_sign(self, ml, signature):
        ...
        command =  ["tpm2_sign", "-c", keyhandle, "-p", aik_pw, "-o", signature, "-f", "plain", "-g", "sha256", "msg"]
    ...
    def create_quote(self, nonce, data=None, pcrmask=tpm_abstract.AbstractTPM.EMPTYMASK, hash_alg=None, physical_tpm = None):
        if hash_alg is None:
            hash_alg = self.defaults['hash']
